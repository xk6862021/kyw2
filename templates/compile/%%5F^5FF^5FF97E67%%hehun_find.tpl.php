<?php /* Smarty version 2.6.25, created on 2019-12-26 17:40:41
...
<meta name="description" content="易读网提供婚姻测算八字合婚服务，解开婚姻与八字的姻缘关系，普渡每一个善信的有缘人，我们衷心祝愿您拥有幸福的婚姻生活。" />
...
四宅的房子为最佳，最佳坐向：<?php echo $this->_tpl_vars['data']['m_vfw']; ?>
	...
	<div class="public_lock_content">
		<div class="list2 left">
			<p><?php echo $this->_tpl_vars['data']['name_a']; ?>
与<?php echo $this->_tpl_vars['data']['name']; ?>
的八字五行互补性不强，如果你们已经是朋友，可通过后天的一些措施来补救。如工作行业、方位、颜色、饮食、兴趣、日常用品等。</p>
			<p><?php echo $this->_tpl_vars['data']['name_a']; ?>
官杀强，<?php echo $this->_tpl_vars['data']['name']; ?>
食伤强，十神关系上有互补，两人互相平衡，协调发展。</p>
			<p>二位命卦组成'延年'，此为上等婚，可和睦相处，白头到老。(甲方命卦：坤二（西四命） 乙方命卦：乾六（西四命）)</p>
			<p>二位属相没有特殊组合，配合情况一般。(男方属相：<?php echo $this->_tpl_vars['data']['shengxiao1']; ?>
 女方属相：<?php echo $this->_tpl_vars['data']['shengxiao2']; ?>
	...
	<div class="public_lock_content">
		<div class="list2 left">
			<p><b style="color:#00b98d;"><?php echo $this->_tpl_vars['data']['name']; ?>
性格:</b></p>
			...
			<p><b style="color:#00b98d;"><?php echo $this->_tpl_vars['data']['name_a']; ?>
性格:</b></p>
	...
	<div class="public_lock_content">
		<div class="list2 left">
			...
			<p><?php echo $this->_tpl_vars['data']['name']; ?>
比劫强，<?php echo $this->_tpl_vars['data']['name_a']; ?>
食伤强，十神关系上有互补，两人互相平衡，协调发展。二位命卦组成”五鬼，此为中等婚，根据合婚规律组合，双方可以在一起。</p>
			<p><?php echo $this->_tpl_vars['data']['name']; ?>
：命卦：坎一（东四命）</p>
			<p><?php echo $this->_tpl_vars['data']['name_a']; ?>
：命卦：中宫寄艮（西四命）</p>
...
的婚姻</b></p>
			...
			<p><?php echo $this->_tpl_vars['data']['name']; ?>
的命财弱，适宜晚婚，否则于事业家庭方面发展壮大有阻碍。</p>
			<p>日支受刑，适宜晚婚，否则于事业家庭有阻碍。</p>
			<p><b style="color:#00b98d;"><?php echo $this->_tpl_vars['data']['name_a']; ?>
的婚姻</b></p>
			<p>年日干支相同，婚姻不顺或不利配偶。</p>
			<p><?php echo $this->_tpl_vars['data']['name_a']; ?>
的日支比肩为忌时，<?php echo $this->_tpl_vars['data']['name']; ?>
则消极被动，草率马虎，意志薄弱，短视浅虑，我行我素。</p>
			<p>食神太过，不见夫星，贞洁之妇。</p>
			<p>食神得地利子。</p>
	...
	<div class="public_lock_content">
		<div class="list2 left">
			...
			<p>建议二位可以在生活上做一些五行互补，增强双方之间的感情，根据<?php echo $this->_tpl_vars['data']['name']; ?>
的五行，建议佩戴一些黑色饰品，用以提升感情质量，或者二位共同佩戴一些成双成对的饰品也可。</p>
		</div>
	</div>
	<div class="public_bzhh_title J_payPopupShow">
	...
	<div class="public_lock_content">
		<div class="list2 left">
			<p>综合分析二位八字合婚可以划分为中等婚姻，双方在一起务必要收敛自己的不足之地，例如<?php echo $this->_tpl_vars['data']['name']; ?>
比劫重，注意性格要多克制，否则也会引起感情危机。</p>
